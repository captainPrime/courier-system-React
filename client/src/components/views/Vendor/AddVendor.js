...
import { countryList, IdType } from './data'
...
function AddVendor(props) {
    ...
    const IDTYPE = IdType.map((item, index) => {
        return <Select.Option key={index} value={item}>{item}</Select.Option>
    })
    ...
    const handleSubmit = async (event) => {
        ...
        await Axios.post('/api/users/addVendor/', variables)
            .then(res => {
                if (res.data.success) {
                        ...
                        <Row gutter={[16, 16]}>
                            ...
                            <Col lg={5} md={12} sm={24}>
                                <Form.Item label="Company *">
                                    <Input type="text" name="company" onChange={handleInput} required />
                                </Form.Item>
                            </Col>
                            <Col lg={5} md={12} sm={24} >
                            ...
                            <Col lg={5} md={12} sm={24} >
                                <Form.Item label="ID Number">
                                    <Input type="text" name="idnumber" onChange={handleInput} />
                                </Form.Item>
                            </Col>
                            <Col lg={4} md={12} sm={24}>
                                <Form.Item label="ID type">
                                    <Select defaultValue="E (EIN)" style={{ width: "100%" }} onChange={handleIDType}>
                                        {IDTYPE}
                                    </Select>
                                </Form.Item>
                            </Col>
